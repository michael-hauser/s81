...
var file_gtfs_realtime_proto_rawDesc = []byte{
	...
	0x4e, 0x42, 0x5a, 0x0a, 0x1b, 0x63, 0x6f, 0x6d, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e,
	0x74, 0x72, 0x61, 0x6e, 0x73, 0x69, 0x74, 0x2e, 0x72, 0x65, 0x61, 0x6c, 0x74, 0x69, 0x6d, 0x65,
	0x5a, 0x3b, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x6d, 0x69, 0x63,
	0x68, 0x61, 0x65, 0x6c, 0x2d, 0x68, 0x61, 0x75, 0x73, 0x65, 0x72, 0x2f, 0x73, 0x38, 0x31, 0x2f,
	0x73, 0x75, 0x62, 0x77, 0x61, 0x79, 0x2d, 0x70, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x65, 0x72, 0x2f,
	0x67, 0x74, 0x66, 0x73, 0x2d, 0x72, 0x65, 0x61, 0x6c, 0x74, 0x69, 0x6d, 0x65,
}
...
func file_gtfs_realtime_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_gtfs_realtime_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_gtfs_realtime_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_gtfs_realtime_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_gtfs_realtime_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_gtfs_realtime_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_gtfs_realtime_proto_msgTypes[5].Exporter = func(v any, i int) any {
			switch v := v.(*Alert); i {
			case 0:
				return &v.state
			case 1:
		...
		file_gtfs_realtime_proto_msgTypes[6].Exporter = func(v any, i int) any {
		...
		file_gtfs_realtime_proto_msgTypes[7].Exporter = func(v any, i int) any {
		...
		file_gtfs_realtime_proto_msgTypes[8].Exporter = func(v any, i int) any {
		...
		file_gtfs_realtime_proto_msgTypes[9].Exporter = func(v any, i int) any {
		...
		file_gtfs_realtime_proto_msgTypes[10].Exporter = func(v any, i int) any {
		...
		file_gtfs_realtime_proto_msgTypes[11].Exporter = func(v any, i int) any {
		...
		file_gtfs_realtime_proto_msgTypes[12].Exporter = func(v any, i int) any {
		...
		file_gtfs_realtime_proto_msgTypes[13].Exporter = func(v any, i int) any {
			switch v := v.(*Shape); i {
			case 0:
				return &v.state
			case 1:
		...
		file_gtfs_realtime_proto_msgTypes[14].Exporter = func(v any, i int) any {
			switch v := v.(*Stop); i {
			case 0:
				return &v.state
			case 1:
		...
		file_gtfs_realtime_proto_msgTypes[15].Exporter = func(v any, i int) any {
		...
		file_gtfs_realtime_proto_msgTypes[16].Exporter = func(v any, i int) any {
		...
		file_gtfs_realtime_proto_msgTypes[17].Exporter = func(v any, i int) any {
		...
		file_gtfs_realtime_proto_msgTypes[18].Exporter = func(v any, i int) any {
		...
		file_gtfs_realtime_proto_msgTypes[19].Exporter = func(v any, i int) any {
		...
		file_gtfs_realtime_proto_msgTypes[20].Exporter = func(v any, i int) any {
		...
		file_gtfs_realtime_proto_msgTypes[21].Exporter = func(v any, i int) any {
		...
		file_gtfs_realtime_proto_msgTypes[22].Exporter = func(v any, i int) any {
		...
		file_gtfs_realtime_proto_msgTypes[23].Exporter = func(v any, i int) any {
		...
		file_gtfs_realtime_proto_msgTypes[24].Exporter = func(v any, i int) any {
		...
		file_gtfs_realtime_proto_msgTypes[25].Exporter = func(v any, i int) any {
		...
		file_gtfs_realtime_proto_msgTypes[26].Exporter = func(v any, i int) any {
		...
		file_gtfs_realtime_proto_msgTypes[27].Exporter = func(v any, i int) any {
